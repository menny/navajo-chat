...
def generate_junit5_deps_workspace_rules():
    ...
    http_file(name = 'junit5___org_junit_platform__junit-platform-launcher__1_3_2',
    ...
    http_file(name = 'junit5___org_junit_jupiter__junit-jupiter-params__5_3_2',
    ...
    http_file(name = 'junit5___org_junit_platform__junit-platform-commons__1_3_2',
    ...
    http_file(name = 'junit5___org_junit_platform__junit-platform-suite-api__1_3_2',
    ...
    http_file(name = 'junit5___org_junit_jupiter__junit-jupiter-api__5_3_2',
    ...
    http_file(name = 'junit5___org_junit_jupiter__junit-jupiter-engine__5_3_2',
    ...
    http_file(name = 'junit5___org_junit_platform__junit-platform-console__1_3_2',
    ...
    # org.junit.platform:junit-platform-engine:jar:1.3.2 got requested version
    # org.junit.jupiter:junit-jupiter-api:jar:5.3.2 got requested version
    http_file(name = 'junit5___org_opentest4j__opentest4j__1_1_1',
    ...
    # org.junit.jupiter:junit-jupiter-api:jar:5.3.2 got requested version
    # org.junit.jupiter:junit-jupiter-engine:jar:5.3.2 got requested version
    http_file(name = 'junit5___org_apiguardian__apiguardian-api__1_0_0',
    ...
    # org.junit.platform:junit-platform-launcher:jar:1.3.2 got requested version
    # org.junit.jupiter:junit-jupiter-engine:jar:5.3.2 got requested version
    http_file(name = 'junit5___org_junit_platform__junit-platform-engine__1_3_2',
...
def generate_junit5_deps_transitive_dependency_rules(kt_jvm_import=None, kt_jvm_library=None):
    native.java_import(name = 'junit5___org_junit_platform__junit-platform-launcher__1_3_2',
    ...
    native.alias(name = 'junit5___org_junit_platform__junit_platform_launcher',
    ...
    if kt_jvm_import == None:
        native.java_import(name = 'junit5___org_junit_jupiter__junit-jupiter-params__5_3_2',
        ...
        kt_jvm_import(name = 'junit5___org_junit_jupiter__junit-jupiter-params__5_3_2_kotlin_jar',
            jars = ['@junit5___org_junit_jupiter__junit-jupiter-params__5_3_2//file'],
        )

        kt_jvm_library(name = 'junit5___org_junit_jupiter__junit-jupiter-params__5_3_2',
            runtime_deps = [
                ':junit5___org_apiguardian__apiguardian_api',
    ...
    native.alias(name = 'junit5___org_junit_jupiter__junit_jupiter_params',
        actual = 'junit5___org_junit_jupiter__junit-jupiter-params__5_3_2',
        visibility = ['//visibility:public'],
    )


    native.java_import(name = 'junit5___org_junit_platform__junit-platform-commons__1_3_2',
        jars = ['@junit5___org_junit_platform__junit-platform-commons__1_3_2//file'],
        deps = [':junit5___org_apiguardian__apiguardian_api'],
        exports = [':junit5___org_apiguardian__apiguardian_api'],
        runtime_deps = [],
    )

    native.alias(name = 'junit5___org_junit_platform__junit_platform_commons',
        actual = 'junit5___org_junit_platform__junit-platform-commons__1_3_2',
        visibility = ['//visibility:public'],
    )


    native.java_import(name = 'junit5___org_junit_platform__junit-platform-suite-api__1_3_2',
    ...
    native.alias(name = 'junit5___org_junit_platform__junit_platform_suite_api',
    ...
    if kt_jvm_import == None:
        native.java_import(name = 'junit5___org_junit_jupiter__junit-jupiter-api__5_3_2',
        ...
        kt_jvm_import(name = 'junit5___org_junit_jupiter__junit-jupiter-api__5_3_2_kotlin_jar',
            jars = ['@junit5___org_junit_jupiter__junit-jupiter-api__5_3_2//file'],
        )

        kt_jvm_library(name = 'junit5___org_junit_jupiter__junit-jupiter-api__5_3_2',
            runtime_deps = [
                ':junit5___org_apiguardian__apiguardian_api',
    ...
    native.alias(name = 'junit5___org_junit_jupiter__junit_jupiter_api',
        actual = 'junit5___org_junit_jupiter__junit-jupiter-api__5_3_2',
        visibility = ['//visibility:public'],
    )


    native.java_import(name = 'junit5___org_junit_jupiter__junit-jupiter-engine__5_3_2',
    ...
    native.alias(name = 'junit5___org_junit_jupiter__junit_jupiter_engine',
        actual = 'junit5___org_junit_jupiter__junit-jupiter-engine__5_3_2',
        visibility = ['//visibility:public'],
    )


    native.java_import(name = 'junit5___org_junit_platform__junit-platform-console__1_3_2',
    ...
    native.alias(name = 'junit5___org_junit_platform__junit_platform_console',
        actual = 'junit5___org_junit_platform__junit-platform-console__1_3_2',
        visibility = ['//visibility:public'],
    )


    native.java_import(name = 'junit5___org_opentest4j__opentest4j__1_1_1',
    ...
    native.alias(name = 'junit5___org_opentest4j__opentest4j',
        actual = 'junit5___org_opentest4j__opentest4j__1_1_1',
        visibility = ['//visibility:public'],
    )


    native.java_import(name = 'junit5___org_apiguardian__apiguardian-api__1_0_0',
    ...
    native.alias(name = 'junit5___org_apiguardian__apiguardian_api',
        actual = 'junit5___org_apiguardian__apiguardian-api__1_0_0',
        visibility = ['//visibility:public'],
    )


    native.java_import(name = 'junit5___org_junit_platform__junit-platform-engine__1_3_2',
    ...
    native.alias(name = 'junit5___org_junit_platform__junit_platform_engine',
