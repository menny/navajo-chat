...
def generate_workspace_rules():
    ...
    http_file(name = 'main_deps___com_google_guava__failureaccess__1_0',
    ...
    http_file(name = 'main_deps___io_mockk__mockk-agent-api__1_8_13_kotlin13',
    ...
    http_file(name = 'main_deps___io_mockk__mockk__1_8_13_kotlin13',
    ...
    http_file(name = 'main_deps___com_spotify_mobius__mobius-extras__1_2_0',
    ...
    http_file(name = 'main_deps___io_mockk__mockk-common__1_8_13_kotlin13',
    ...
    # com.github.menny.Chauffeur:lib:aar:90e7032 wanted version 1.1.0-alpha01
    # androidx.appcompat:appcompat:aar:1.0.2 wanted version 1.0.0
    # com.github.menny.Chauffeur:permissions:aar:90e7032 wanted version 1.1.0-alpha01
    ...
    http_file(name = 'main_deps___com_spotify_mobius__mobius-android__1_2_0',
    ...
    # com.google.guava:guava:bundle:27.0-android
    http_file(name = 'main_deps___com_google_guava__listenablefuture__9999_0-empty-to-avoid-conflict-with-guava',
    ...
    http_file(name = 'main_deps___com_google_guava__guava__27_0-android',
    ...
    http_file(name = 'main_deps___org_slf4j__slf4j-api__1_7_25',
    ...
    http_file(name = 'main_deps___androidx_constraintlayout__constraintlayout-solver__1_1_3',
        urls = ['https://maven.google.com/androidx/constraintlayout/constraintlayout-solver/1.1.3/constraintlayout-solver-1.1.3.jar'],
        downloaded_file_path = 'constraintlayout-solver-1.1.3.jar',
    )
    http_file(name = 'main_deps___io_reactivex_rxjava2__rxandroid__2_1_0',
    ...
    http_file(name = 'main_deps___javax_annotation__jsr250-api__1_0',
    ...
    # io.mockk:mockk:jar:1.8.13.kotlin13
    http_file(name = 'main_deps___io_mockk__mockk-agent-jvm__1_8_13_kotlin13',
    ...
    http_file(name = 'main_deps___com_github_menny_Chauffeur__lib__90e7032',
        urls = ['https://jitpack.io/com/github/menny/Chauffeur/lib/90e7032/lib-90e7032.aar'],
        downloaded_file_path = 'lib-90e7032.aar',
    )
    http_file(name = 'main_deps___com_spotify_mobius__mobius-rx2__1_2_0',
    ...
    http_file(name = 'main_deps___androidx_constraintlayout__constraintlayout__1_1_3',
        urls = ['https://maven.google.com/androidx/constraintlayout/constraintlayout/1.1.3/constraintlayout-1.1.3.aar'],
        downloaded_file_path = 'constraintlayout-1.1.3.aar',
    )
    # io.mockk:mockk:jar:1.8.13.kotlin13
    http_file(name = 'main_deps___io_mockk__mockk-dsl-jvm__1_8_13_kotlin13',
    ...
    # androidx.activity:activity:aar:1.0.0-alpha02 got requested version
    # androidx.swiperefreshlayout:swiperefreshlayout:aar:1.0.0 got requested version
    ...
    # androidx.fragment:fragment:aar:1.1.0-alpha02 got requested version
    ...
    # androidx.fragment:fragment:aar:1.1.0-alpha02
    ...
    http_file(name = 'main_deps___io_mockk__mockk-dsl__1_8_13_kotlin13',
    ...
    http_file(name = 'main_deps___io_reactivex_rxjava2__rxjava__2_2_4',
    ...
    # com.google.guava:guava:bundle:27.0-android
    http_file(name = 'main_deps___org_codehaus_mojo__animal-sniffer-annotations__1_17',
    ...
    http_file(name = 'main_deps___com_spotify_mobius__mobius-core__1_2_0',
    ...
    # io.mockk:mockk-agent-jvm:jar:1.8.13.kotlin13
    http_file(name = 'main_deps___io_mockk__mockk-agent-common__1_8_13_kotlin13',
    ...
    # androidx.activity:activity:aar:1.0.0-alpha02 wanted version 1.0.0
    ...
    # io.mockk:mockk-agent-jvm:jar:1.8.13.kotlin13
    http_file(name = 'main_deps___net_bytebuddy__byte-buddy__1_8_22',
    ...
    # com.google.guava:guava:bundle:27.0-android
    http_file(name = 'main_deps___com_google_j2objc__j2objc-annotations__1_1',
    ...
    http_file(name = 'main_deps___com_github_menny_Chauffeur__permissions__90e7032',
    ...
    # com.google.guava:guava:bundle:27.0-android
    http_file(name = 'main_deps___org_checkerframework__checker-compat-qual__2_5_2',
    ...
    http_file(name = 'main_deps___org_jetbrains_kotlin__kotlin-reflect__1_3_0',
    ...
    http_file(name = 'main_deps___org_reactivestreams__reactive-streams__1_0_2',
    ...
    http_file(name = 'main_deps___org_jetbrains_kotlin__kotlin-stdlib__1_3_0',
    ...
    # io.mockk:mockk-agent-jvm:jar:1.8.13.kotlin13
    http_file(name = 'main_deps___net_bytebuddy__byte-buddy-agent__1_8_22',
    ...
    http_file(name = 'main_deps___org_jetbrains_kotlin__kotlin-stdlib-common__1_3_0',
    ...
    # org.jetbrains.kotlin:kotlin-stdlib:jar:1.3.0
    http_file(name = 'main_deps___org_jetbrains__annotations__13_0',
...
def generate_transitive_dependency_targets(kt_jvm_import=None, kt_jvm_library=None):
    ...
    native.java_import(name = 'main_deps___com_google_guava__failureaccess__1_0',
        jars = ['@main_deps___com_google_guava__failureaccess__1_0//file'],
        deps = [],
        exports = [],
        runtime_deps = [],
    )
    ...
    native.alias(name = 'main_deps___com_google_guava__failureaccess',
        actual = 'main_deps___com_google_guava__failureaccess__1_0',
        visibility = ['//visibility:public'],
    )
    ...
    if kt_jvm_import == None:
        native.java_import(name = 'main_deps___io_mockk__mockk-agent-api__1_8_13_kotlin13',
            jars = ['@main_deps___io_mockk__mockk-agent-api__1_8_13_kotlin13//file'],
            deps = [],
            exports = [],
            runtime_deps = [],
        )
    else:
        kt_jvm_import(name = 'main_deps___io_mockk__mockk-agent-api__1_8_13_kotlin13_kotlin_jar',
            jars = ['@main_deps___io_mockk__mockk-agent-api__1_8_13_kotlin13//file'],
        )

        kt_jvm_library(name = 'main_deps___io_mockk__mockk-agent-api__1_8_13_kotlin13',
            runtime_deps = [':main_deps___io_mockk__mockk-agent-api__1_8_13_kotlin13_kotlin_jar'],
            exports = [':main_deps___io_mockk__mockk-agent-api__1_8_13_kotlin13_kotlin_jar'],
        )

    native.alias(name = 'main_deps___io_mockk__mockk_agent_api',
        actual = 'main_deps___io_mockk__mockk-agent-api__1_8_13_kotlin13',
        visibility = ['//visibility:public'],
    )

    if kt_jvm_import == None:
        native.java_import(name = 'main_deps___io_mockk__mockk__1_8_13_kotlin13',
            jars = ['@main_deps___io_mockk__mockk__1_8_13_kotlin13//file'],
            deps = [
                ':main_deps___io_mockk__mockk_agent_jvm',
                ':main_deps___io_mockk__mockk_common',
                ':main_deps___io_mockk__mockk_dsl_jvm',
                ':main_deps___org_jetbrains_kotlin__kotlin_reflect',
            ],
            exports = [
                ':main_deps___io_mockk__mockk_agent_jvm',
                ':main_deps___io_mockk__mockk_common',
        ...
        kt_jvm_import(name = 'main_deps___io_mockk__mockk__1_8_13_kotlin13_kotlin_jar',
            jars = ['@main_deps___io_mockk__mockk__1_8_13_kotlin13//file'],
        )

        kt_jvm_library(name = 'main_deps___io_mockk__mockk__1_8_13_kotlin13',
            runtime_deps = [
                ':main_deps___io_mockk__mockk__1_8_13_kotlin13_kotlin_jar',
                ':main_deps___io_mockk__mockk_agent_jvm',
                ':main_deps___io_mockk__mockk_common',
                ':main_deps___io_mockk__mockk_dsl_jvm',
                ':main_deps___org_jetbrains_kotlin__kotlin_reflect',
    ...
    native.alias(name = 'main_deps___io_mockk__mockk',
        actual = 'main_deps___io_mockk__mockk__1_8_13_kotlin13',
        visibility = ['//visibility:public'],
    )
    ...
    native.java_import(name = 'main_deps___com_spotify_mobius__mobius-extras__1_2_0',
        jars = ['@main_deps___com_spotify_mobius__mobius-extras__1_2_0//file'],
        deps = [':main_deps___com_spotify_mobius__mobius_core'],
        exports = [':main_deps___com_spotify_mobius__mobius_core'],
        runtime_deps = [
            ':main_deps___com_google_code_findbugs__jsr305',
            ':main_deps___org_slf4j__slf4j_api',
        ],
    )

    native.alias(name = 'main_deps___com_spotify_mobius__mobius_extras',
        actual = 'main_deps___com_spotify_mobius__mobius-extras__1_2_0',
        visibility = ['//visibility:public'],
    )
    ...
    if kt_jvm_import == None:
        native.java_import(name = 'main_deps___io_mockk__mockk-common__1_8_13_kotlin13',
            jars = ['@main_deps___io_mockk__mockk-common__1_8_13_kotlin13//file'],
            deps = [':main_deps___io_mockk__mockk_dsl'],
            exports = [':main_deps___io_mockk__mockk_dsl'],
            runtime_deps = [],
        )
    else:
        kt_jvm_import(name = 'main_deps___io_mockk__mockk-common__1_8_13_kotlin13_kotlin_jar',
            jars = ['@main_deps___io_mockk__mockk-common__1_8_13_kotlin13//file'],
        )

        kt_jvm_library(name = 'main_deps___io_mockk__mockk-common__1_8_13_kotlin13',
            runtime_deps = [
                ':main_deps___io_mockk__mockk-common__1_8_13_kotlin13_kotlin_jar',
                ':main_deps___io_mockk__mockk_dsl',
            ],
            exports = [
                ':main_deps___io_mockk__mockk-common__1_8_13_kotlin13_kotlin_jar',
                ':main_deps___io_mockk__mockk_dsl',
    ...
    native.alias(name = 'main_deps___io_mockk__mockk_common',
        actual = 'main_deps___io_mockk__mockk-common__1_8_13_kotlin13',
        visibility = ['//visibility:public'],
    )
    ...
    native.aar_import(name = 'main_deps___com_spotify_mobius__mobius-android__1_2_0',
        aar = '@main_deps___com_spotify_mobius__mobius-android__1_2_0//file',
        deps = [
            ':main_deps___com_google_code_findbugs__jsr305',
            ':main_deps___com_spotify_mobius__mobius_core',
            ':main_deps___org_slf4j__slf4j_api',
        ],
        exports = [
            ':main_deps___com_google_code_findbugs__jsr305',
    ...
    native.alias(name = 'main_deps___com_spotify_mobius__mobius_android',
        actual = 'main_deps___com_spotify_mobius__mobius-android__1_2_0',
        visibility = ['//visibility:public'],
    )
    ...
    native.java_import(name = 'main_deps___com_google_guava__listenablefuture__9999_0-empty-to-avoid-conflict-with-guava',
        jars = ['@main_deps___com_google_guava__listenablefuture__9999_0-empty-to-avoid-conflict-with-guava//file'],
        deps = [],
        exports = [],
        runtime_deps = [],
    )
    ...
    native.alias(name = 'main_deps___com_google_guava__listenablefuture',
        actual = 'main_deps___com_google_guava__listenablefuture__9999_0-empty-to-avoid-conflict-with-guava',
        visibility = ['//visibility:public'],
    )

    native.java_import(name = 'main_deps___com_google_guava__guava__27_0-android',
        jars = ['@main_deps___com_google_guava__guava__27_0-android//file'],
        deps = [
            ':main_deps___com_google_code_findbugs__jsr305',
            ...
            ':main_deps___org_checkerframework__checker_compat_qual',
    ...
    native.alias(name = 'main_deps___com_google_guava__guava',
        actual = 'main_deps___com_google_guava__guava__27_0-android',
        visibility = ['//visibility:public'],
    )
    ...
    native.java_import(name = 'main_deps___org_slf4j__slf4j-api__1_7_25',
        jars = ['@main_deps___org_slf4j__slf4j-api__1_7_25//file'],
        deps = [],
        exports = [],
        runtime_deps = [],
    )
    ...
    native.alias(name = 'main_deps___org_slf4j__slf4j_api',
        actual = 'main_deps___org_slf4j__slf4j-api__1_7_25',
        visibility = ['//visibility:public'],
    )

    native.java_import(name = 'main_deps___androidx_constraintlayout__constraintlayout-solver__1_1_3',
        jars = ['@main_deps___androidx_constraintlayout__constraintlayout-solver__1_1_3//file'],
        deps = [],
        exports = [],
        runtime_deps = [],
    )

    native.alias(name = 'main_deps___androidx_constraintlayout__constraintlayout_solver',
        actual = 'main_deps___androidx_constraintlayout__constraintlayout-solver__1_1_3',
        visibility = ['//visibility:public'],
    )

    native.aar_import(name = 'main_deps___io_reactivex_rxjava2__rxandroid__2_1_0',
        aar = '@main_deps___io_reactivex_rxjava2__rxandroid__2_1_0//file',
        deps = [':main_deps___io_reactivex_rxjava2__rxjava'],
        exports = [':main_deps___io_reactivex_rxjava2__rxjava'],
    )

    native.alias(name = 'main_deps___io_reactivex_rxjava2__rxandroid',
        actual = 'main_deps___io_reactivex_rxjava2__rxandroid__2_1_0',
        visibility = ['//visibility:public'],
    )
    ...
    native.java_import(name = 'main_deps___javax_annotation__jsr250-api__1_0',
        jars = ['@main_deps___javax_annotation__jsr250-api__1_0//file'],
        deps = [],
        exports = [],
        runtime_deps = [],
    )

    native.alias(name = 'main_deps___javax_annotation__jsr250_api',
        actual = 'main_deps___javax_annotation__jsr250-api__1_0',
        visibility = ['//visibility:public'],
    )
    ...
    if kt_jvm_import == None:
        native.java_import(name = 'main_deps___io_mockk__mockk-agent-jvm__1_8_13_kotlin13',
            jars = ['@main_deps___io_mockk__mockk-agent-jvm__1_8_13_kotlin13//file'],
            deps = [
                ':main_deps___io_mockk__mockk_agent_api',
                ':main_deps___io_mockk__mockk_agent_common',
            ...
            runtime_deps = [':main_deps___net_bytebuddy__byte_buddy_agent'],
        )
    else:
        kt_jvm_import(name = 'main_deps___io_mockk__mockk-agent-jvm__1_8_13_kotlin13_kotlin_jar',
            jars = ['@main_deps___io_mockk__mockk-agent-jvm__1_8_13_kotlin13//file'],
        )

        kt_jvm_library(name = 'main_deps___io_mockk__mockk-agent-jvm__1_8_13_kotlin13',
            runtime_deps = [
                ':main_deps___io_mockk__mockk-agent-jvm__1_8_13_kotlin13_kotlin_jar',
                ':main_deps___io_mockk__mockk_agent_api',
                ':main_deps___io_mockk__mockk_agent_common',
                ':main_deps___net_bytebuddy__byte_buddy',
    ...
    native.alias(name = 'main_deps___io_mockk__mockk_agent_jvm',
        actual = 'main_deps___io_mockk__mockk-agent-jvm__1_8_13_kotlin13',
        visibility = ['//visibility:public'],
    )

    native.aar_import(name = 'main_deps___com_github_menny_Chauffeur__lib__90e7032',
        aar = '@main_deps___com_github_menny_Chauffeur__lib__90e7032//file',
        deps = [
            ':main_deps___androidx_annotation__annotation',
    ...
    native.alias(name = 'main_deps___com_github_menny_Chauffeur__lib',
        actual = 'main_deps___com_github_menny_Chauffeur__lib__90e7032',
        visibility = ['//visibility:public'],
    )

    native.java_import(name = 'main_deps___com_spotify_mobius__mobius-rx2__1_2_0',
        jars = ['@main_deps___com_spotify_mobius__mobius-rx2__1_2_0//file'],
        deps = [
            ':main_deps___com_spotify_mobius__mobius_core',
            ':main_deps___io_reactivex_rxjava2__rxjava',
        ],
        exports = [
            ':main_deps___com_spotify_mobius__mobius_core',
            ':main_deps___io_reactivex_rxjava2__rxjava',
        ],
        runtime_deps = [':main_deps___com_google_code_findbugs__jsr305'],
    )

    native.alias(name = 'main_deps___com_spotify_mobius__mobius_rx2',
        actual = 'main_deps___com_spotify_mobius__mobius-rx2__1_2_0',
        visibility = ['//visibility:public'],
    )

    native.aar_import(name = 'main_deps___androidx_constraintlayout__constraintlayout__1_1_3',
        aar = '@main_deps___androidx_constraintlayout__constraintlayout__1_1_3//file',
        deps = [':main_deps___androidx_constraintlayout__constraintlayout_solver'],
        exports = [':main_deps___androidx_constraintlayout__constraintlayout_solver'],
    )

    native.alias(name = 'main_deps___androidx_constraintlayout__constraintlayout',
        actual = 'main_deps___androidx_constraintlayout__constraintlayout__1_1_3',
        visibility = ['//visibility:public'],
    )

    if kt_jvm_import == None:
        native.java_import(name = 'main_deps___io_mockk__mockk-dsl-jvm__1_8_13_kotlin13',
            jars = ['@main_deps___io_mockk__mockk-dsl-jvm__1_8_13_kotlin13//file'],
            deps = [
                ':main_deps___io_mockk__mockk_dsl',
                ':main_deps___org_jetbrains_kotlin__kotlin_reflect',
            ],
        ...
        kt_jvm_import(name = 'main_deps___io_mockk__mockk-dsl-jvm__1_8_13_kotlin13_kotlin_jar',
            jars = ['@main_deps___io_mockk__mockk-dsl-jvm__1_8_13_kotlin13//file'],
        )

        kt_jvm_library(name = 'main_deps___io_mockk__mockk-dsl-jvm__1_8_13_kotlin13',
            runtime_deps = [
                ':main_deps___io_mockk__mockk-dsl-jvm__1_8_13_kotlin13_kotlin_jar',
                ':main_deps___io_mockk__mockk_dsl',
                ':main_deps___org_jetbrains_kotlin__kotlin_reflect',
            ],
            exports = [
    ...
    native.alias(name = 'main_deps___io_mockk__mockk_dsl_jvm',
        actual = 'main_deps___io_mockk__mockk-dsl-jvm__1_8_13_kotlin13',
        visibility = ['//visibility:public'],
    )
    ...
    if kt_jvm_import == None:
        native.java_import(name = 'main_deps___io_mockk__mockk-dsl__1_8_13_kotlin13',
            jars = ['@main_deps___io_mockk__mockk-dsl__1_8_13_kotlin13//file'],
            deps = [],
            exports = [],
            runtime_deps = [],
        )
    else:
        kt_jvm_import(name = 'main_deps___io_mockk__mockk-dsl__1_8_13_kotlin13_kotlin_jar',
            jars = ['@main_deps___io_mockk__mockk-dsl__1_8_13_kotlin13//file'],
        )

        kt_jvm_library(name = 'main_deps___io_mockk__mockk-dsl__1_8_13_kotlin13',
            runtime_deps = [':main_deps___io_mockk__mockk-dsl__1_8_13_kotlin13_kotlin_jar'],
            exports = [':main_deps___io_mockk__mockk-dsl__1_8_13_kotlin13_kotlin_jar'],
        )

    native.alias(name = 'main_deps___io_mockk__mockk_dsl',
        actual = 'main_deps___io_mockk__mockk-dsl__1_8_13_kotlin13',
        visibility = ['//visibility:public'],
    )
    ...
    native.java_import(name = 'main_deps___io_reactivex_rxjava2__rxjava__2_2_4',
        jars = ['@main_deps___io_reactivex_rxjava2__rxjava__2_2_4//file'],
        deps = [':main_deps___org_reactivestreams__reactive_streams'],
        exports = [':main_deps___org_reactivestreams__reactive_streams'],
        runtime_deps = [],
    )

    native.alias(name = 'main_deps___io_reactivex_rxjava2__rxjava',
        actual = 'main_deps___io_reactivex_rxjava2__rxjava__2_2_4',
        visibility = ['//visibility:public'],
    )
    ...
    native.java_import(name = 'main_deps___org_codehaus_mojo__animal-sniffer-annotations__1_17',
        jars = ['@main_deps___org_codehaus_mojo__animal-sniffer-annotations__1_17//file'],
        deps = [],
        exports = [],
        runtime_deps = [],
    )
    ...
    native.alias(name = 'main_deps___org_codehaus_mojo__animal_sniffer_annotations',
        actual = 'main_deps___org_codehaus_mojo__animal-sniffer-annotations__1_17',
        visibility = ['//visibility:public'],
    )
    ...
    native.java_import(name = 'main_deps___com_spotify_mobius__mobius-core__1_2_0',
        jars = ['@main_deps___com_spotify_mobius__mobius-core__1_2_0//file'],
        deps = [],
        exports = [],
        runtime_deps = [
            ':main_deps___com_google_code_findbugs__jsr305',
    ...
    native.alias(name = 'main_deps___com_spotify_mobius__mobius_core',
        actual = 'main_deps___com_spotify_mobius__mobius-core__1_2_0',
        visibility = ['//visibility:public'],
    )
    ...
    if kt_jvm_import == None:
        native.java_import(name = 'main_deps___io_mockk__mockk-agent-common__1_8_13_kotlin13',
            jars = ['@main_deps___io_mockk__mockk-agent-common__1_8_13_kotlin13//file'],
            deps = [':main_deps___io_mockk__mockk_agent_api'],
            exports = [':main_deps___io_mockk__mockk_agent_api'],
            runtime_deps = [],
        )
    else:
        kt_jvm_import(name = 'main_deps___io_mockk__mockk-agent-common__1_8_13_kotlin13_kotlin_jar',
            jars = ['@main_deps___io_mockk__mockk-agent-common__1_8_13_kotlin13//file'],
        )

        kt_jvm_library(name = 'main_deps___io_mockk__mockk-agent-common__1_8_13_kotlin13',
            runtime_deps = [
                ':main_deps___io_mockk__mockk-agent-common__1_8_13_kotlin13_kotlin_jar',
                ':main_deps___io_mockk__mockk_agent_api',
            ],
            exports = [
                ':main_deps___io_mockk__mockk-agent-common__1_8_13_kotlin13_kotlin_jar',
    ...
    native.alias(name = 'main_deps___io_mockk__mockk_agent_common',
        actual = 'main_deps___io_mockk__mockk-agent-common__1_8_13_kotlin13',
        visibility = ['//visibility:public'],
    )
    ...
    native.java_import(name = 'main_deps___net_bytebuddy__byte-buddy__1_8_22',
        jars = ['@main_deps___net_bytebuddy__byte-buddy__1_8_22//file'],
    ...
    native.alias(name = 'main_deps___net_bytebuddy__byte_buddy',
        actual = 'main_deps___net_bytebuddy__byte-buddy__1_8_22',
        visibility = ['//visibility:public'],
    )
    ...
    native.java_import(name = 'main_deps___com_google_j2objc__j2objc-annotations__1_1',
        jars = ['@main_deps___com_google_j2objc__j2objc-annotations__1_1//file'],
        deps = [],
        exports = [],
        runtime_deps = [],
    )
    ...
    native.alias(name = 'main_deps___com_google_j2objc__j2objc_annotations',
        actual = 'main_deps___com_google_j2objc__j2objc-annotations__1_1',
        visibility = ['//visibility:public'],
    )
    ...
    native.aar_import(name = 'main_deps___com_github_menny_Chauffeur__permissions__90e7032',
        aar = '@main_deps___com_github_menny_Chauffeur__permissions__90e7032//file',
        deps = [
            ':main_deps___androidx_annotation__annotation',
            ':main_deps___androidx_appcompat__appcompat',
            ':main_deps___androidx_fragment__fragment',
    ...
    native.alias(name = 'main_deps___com_github_menny_Chauffeur__permissions',
        actual = 'main_deps___com_github_menny_Chauffeur__permissions__90e7032',
        visibility = ['//visibility:public'],
    )
    ...
    native.java_import(name = 'main_deps___org_checkerframework__checker-compat-qual__2_5_2',
        jars = ['@main_deps___org_checkerframework__checker-compat-qual__2_5_2//file'],
        deps = [],
        exports = [],
        runtime_deps = [],
    )

    native.alias(name = 'main_deps___org_checkerframework__checker_compat_qual',
        actual = 'main_deps___org_checkerframework__checker-compat-qual__2_5_2',
        visibility = ['//visibility:public'],
    )

    if kt_jvm_import == None:
        native.java_import(name = 'main_deps___org_jetbrains_kotlin__kotlin-reflect__1_3_0',
            jars = ['@main_deps___org_jetbrains_kotlin__kotlin-reflect__1_3_0//file'],
            deps = [':main_deps___org_jetbrains_kotlin__kotlin_stdlib'],
            exports = [':main_deps___org_jetbrains_kotlin__kotlin_stdlib'],
            runtime_deps = [],
        )
    else:
        kt_jvm_import(name = 'main_deps___org_jetbrains_kotlin__kotlin-reflect__1_3_0_kotlin_jar',
            jars = ['@main_deps___org_jetbrains_kotlin__kotlin-reflect__1_3_0//file'],
        )

        kt_jvm_library(name = 'main_deps___org_jetbrains_kotlin__kotlin-reflect__1_3_0',
            runtime_deps = [
                ':main_deps___org_jetbrains_kotlin__kotlin-reflect__1_3_0_kotlin_jar',
    ...
    native.alias(name = 'main_deps___org_jetbrains_kotlin__kotlin_reflect',
        actual = 'main_deps___org_jetbrains_kotlin__kotlin-reflect__1_3_0',
        visibility = ['//visibility:public'],
    )
    ...
    native.java_import(name = 'main_deps___org_reactivestreams__reactive-streams__1_0_2',
        jars = ['@main_deps___org_reactivestreams__reactive-streams__1_0_2//file'],
        deps = [],
        exports = [],
        runtime_deps = [],
    )

    native.alias(name = 'main_deps___org_reactivestreams__reactive_streams',
        actual = 'main_deps___org_reactivestreams__reactive-streams__1_0_2',
        visibility = ['//visibility:public'],
    )

    if kt_jvm_import == None:
        native.java_import(name = 'main_deps___org_jetbrains_kotlin__kotlin-stdlib__1_3_0',
            jars = ['@main_deps___org_jetbrains_kotlin__kotlin-stdlib__1_3_0//file'],
            deps = [
                ':main_deps___org_jetbrains__annotations',
                ':main_deps___org_jetbrains_kotlin__kotlin_stdlib_common',
            ],
            exports = [
                ':main_deps___org_jetbrains__annotations',
                ':main_deps___org_jetbrains_kotlin__kotlin_stdlib_common',
        ...
        kt_jvm_import(name = 'main_deps___org_jetbrains_kotlin__kotlin-stdlib__1_3_0_kotlin_jar',
            jars = ['@main_deps___org_jetbrains_kotlin__kotlin-stdlib__1_3_0//file'],
        )

        kt_jvm_library(name = 'main_deps___org_jetbrains_kotlin__kotlin-stdlib__1_3_0',
            runtime_deps = [
                ':main_deps___org_jetbrains__annotations',
                ':main_deps___org_jetbrains_kotlin__kotlin-stdlib__1_3_0_kotlin_jar',
                ':main_deps___org_jetbrains_kotlin__kotlin_stdlib_common',
            ],
            exports = [
                ':main_deps___org_jetbrains__annotations',
    ...
    native.alias(name = 'main_deps___org_jetbrains_kotlin__kotlin_stdlib',
        actual = 'main_deps___org_jetbrains_kotlin__kotlin-stdlib__1_3_0',
        visibility = ['//visibility:public'],
    )
    ...
    native.java_import(name = 'main_deps___net_bytebuddy__byte-buddy-agent__1_8_22',
        jars = ['@main_deps___net_bytebuddy__byte-buddy-agent__1_8_22//file'],
        deps = [
    ...
    native.alias(name = 'main_deps___net_bytebuddy__byte_buddy_agent',
        actual = 'main_deps___net_bytebuddy__byte-buddy-agent__1_8_22',
        visibility = ['//visibility:public'],
    )
    ...
    if kt_jvm_import == None:
        native.java_import(name = 'main_deps___org_jetbrains_kotlin__kotlin-stdlib-common__1_3_0',
            jars = ['@main_deps___org_jetbrains_kotlin__kotlin-stdlib-common__1_3_0//file'],
            deps = [],
            exports = [],
            runtime_deps = [],
        )
    else:
        kt_jvm_import(name = 'main_deps___org_jetbrains_kotlin__kotlin-stdlib-common__1_3_0_kotlin_jar',
            jars = ['@main_deps___org_jetbrains_kotlin__kotlin-stdlib-common__1_3_0//file'],
        )

        kt_jvm_library(name = 'main_deps___org_jetbrains_kotlin__kotlin-stdlib-common__1_3_0',
            runtime_deps = [':main_deps___org_jetbrains_kotlin__kotlin-stdlib-common__1_3_0_kotlin_jar'],
            exports = [':main_deps___org_jetbrains_kotlin__kotlin-stdlib-common__1_3_0_kotlin_jar'],
        )

    native.alias(name = 'main_deps___org_jetbrains_kotlin__kotlin_stdlib_common',
        actual = 'main_deps___org_jetbrains_kotlin__kotlin-stdlib-common__1_3_0',
        visibility = ['//visibility:public'],
    )
    ...
    native.java_import(name = 'main_deps___org_jetbrains__annotations__13_0',
        jars = ['@main_deps___org_jetbrains__annotations__13_0//file'],
        deps = [],
        exports = [],
        runtime_deps = [],
    )

    native.alias(name = 'main_deps___org_jetbrains__annotations',
        actual = 'main_deps___org_jetbrains__annotations__13_0',
        visibility = ['//visibility:public'],
    )
